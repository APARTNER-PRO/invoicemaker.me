...
if(true || $_POST['action'] === 'pack') {

    $dataString = htmlspecialchars($_POST['data']);
    ...
    // // Step 4: Set document information
    ...
    // // Step 5: Set default header data
    // $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING);

    // // Step 6: Set header and footer fonts
    // $pdf->setHeaderFont(Array(PDF_FONT_NAME_MAIN, '', PDF_FONT_SIZE_MAIN));
    // $pdf->setFooterFont(Array(PDF_FONT_NAME_DATA, '', PDF_FONT_SIZE_DATA));

    // // Step 7: Set default monospaced font
    ...
    // // Step 9: Set auto page breaks
    // $pdf->SetAutoPageBreak(TRUE, PDF_MARGIN_BOTTOM);

    // // Step 10: Set image scale factor
    // $pdf->setImageScale(PDF_IMAGE_SCALE_RATIO);

    // // Step 11: Set some language-dependent strings
    ...
    // // Step 14: Output the HTML content
    // $html = '<h1>Invoice</h1>';
    // $html .= '<p>Invoice Number: ' . $data['invoice_number'] . '</p>';
    // $html .= '<p>Invoice Date: ' . $data['invoice_date'] . '</p>';
    // $html .= '<p>Due Date: ' . $data['due_date'] . '</p>';
    // // Add more HTML content as needed...

    // $pdf->writeHTML($html, true, false, true, false, '');

    // // Step 15: Close and output PDF document
    // // $pdf->Output('invoice.pdf', 'D'); // I for inline rendering, D for download
...
// // Place your invoice data rendering here using $pdf->Cell(), $pdf->MultiCell(), $pdf->WriteHTML() etc.
...
// // This method has several possible parameters: https://tcpdf.org/docs/srcdoc/tcpdf/class-TCPDF/#_output
// // $pdf->Output('invoice1.pdf', 'F'); // 'F' parameter saves the file on the server


// // $pdf->Output('packme/invoice.pdf', 'D');
// $pdf->Output('output/invoice_name.pdf', 'F');
...
//https://invoicefree.local/packme/tcpdf/examples/example_012.php
...
//Close and output PDF document
$pdf->Output('example_01244.pdf', 'D');
// $pdf->Output('example_01244.pdf', 'F');
